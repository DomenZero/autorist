$(document).ready(function(){
	...
	/*	$('.video').width($(window).width()+1100);
		$('.video').height($(window).height()+350);*/
	});
	$('.section').height($(window).height());
...
/*	$('.item1 a').click(function(){
		$('body,html').animate({scrollTop:$('.bg-dark').offset().top},1000);
		return false;
	});*/
	$('.item1 a').click(function(){
	...
	$('.item3 a').click(function(){
		$('body,html').animate({scrollTop:$('.our-clients').offset().top},1000);
		return false;
	});
...
/*	$('.item4 a').click(function(){
		$('body,html').animate({scrollTop:$('.our-clients').offset().center},1000);
		return false;
	});*/
/*	$('.tel2').click(function(){
		$('body,html').animate({scrollTop:$('.consultation').offset().top},1000);
		return false;
	});*/
	$('.item4 a').click(function(){
		$('body,html').animate({scrollTop:$('.consultation').offset().top},1000);
